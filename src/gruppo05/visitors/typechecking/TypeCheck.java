...
import static gruppo05.visitors.typechecking.PrimType.*;
...
public class TypeCheck implements Visitor<Type> {
	...
	/**/
	@Override
	public Type visitForInStmt(VarIdent ident, Exp exp, Block forBlock)
	{
	...
	/**/
	@Override
	public PrimType visitRange(Exp start, Exp end) {
		checkBinOp(start,end,INT);
		return RANGE;
	}
